...
CHeavy::CHeavy()
{
	...
	Animations()->push_back(CAnimationManager::GetInstance()->GetAnimationID("Firebat-Walk-E"));
	Animations()->push_back(CAnimationManager::GetInstance()->GetAnimationID("Firebat-Walk-SE"));
